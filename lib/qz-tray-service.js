  ...
  async connect() {
    try {
      ...
      qz.security.setCertificatePromise(() => {
        // Mock certificate for development - return directly, not wrapped in Promise
        return "-----BEGIN CERTIFICATE-----\nMIIE...DEMO...CERTIFICATE\n-----END CERTIFICATE-----"
      })

      qz.security.setSignaturePromise((toSign) => {
        // Create a simple mock signature hash for development
        // This prevents the circular reference error where toSign becomes the resolver
        const mockSignature = "SHA256withRSA:" + btoa(toSign + "mock-signature-key")
